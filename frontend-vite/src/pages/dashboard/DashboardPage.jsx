  ...
  return (
    <div>
      <header className="mb-8">
        ...
        <p className="text-lg text-brand-text mt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium text-brand-text mb-1">
              Total Revenue
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        {isLoading ? (
          ...
          <p className="p-10 text-center text-brand-text">
